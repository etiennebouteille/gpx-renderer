...
renderQueue.on('global:drained', () => {
    console.log(`No more jobs in the queue, triggering server countdown`)
    const shutdownDelay = 1000 * 60 * 1 //2 minutes en ms
...
app.get('/count', async (req, res) => {
    ...
    //empty() empties the queue, can be useful sometimes
